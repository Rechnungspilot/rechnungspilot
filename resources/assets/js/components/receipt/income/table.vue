<template>
    <div>
            ...
            <table class="table table-hover table-striped bg-white">
                <thead>
                    <tr>
                        ...
                        <th width="10%">Kontakt</th>
                        <th width="10%">Kategorien</th>
        ...
        <div class="alert alert-dark" v-else><center>Keine Einnahmen vorhanden</center></div>
    ...
    export default {
        ...
        methods: {
            ...
            fetch() {
                ...
                axios.get(this.uri + '?searchtext=' + component.searchtext + '&page=' + component.page + '&contact_id=' + component.filter.contactId + '&status_type=' + component.filter.statusType + '&tags=' + component.filter.tags + '&perPage=' + component.filter.perPage)
                    .then(function (response) {
