<template>
    <div class="project-group">
        ...
        <div class="col d-flex align-items-center justify-content-between px-0" style="height: 40px;" v-else>
            <a class="m-0 text-body" style="font-size: 18px;">{{ item.name }}</a>
            <div class="dropdown">
        ...
        <projects :project-group-id="item.id" @fetched="items_count = $event"></projects>
    </div>
            ...
            edit() {
                ...
                axios.put(component.item.path, component.form)
                    .then( function (response) {
                        ...
                        Vue.success('Projektgruppe gespeichert.');
